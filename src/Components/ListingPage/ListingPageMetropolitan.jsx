...
import themet from '../../Images/themet.jpg'; // Correct import of The Metropolitan image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageMetropolitan = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'The Metropolitan') // Filter by property name
        );
  ...
  const listing = {
    image: themet, // Set The Metropolitan image
    title: 'The Metropolitan',
    description: 'Upscale student apartments with resort-style pool, fitness center, and study lounge.'
  };
...
export default ListingPageMetropolitan;
