...
import hub from '../../Images/hub.jpg'; // Correct import of the Hub on Campus Tampa image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageHub = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Hub on Campus Tampa') // Filter by property name
        );
  ...
  const listing = {
    image: hub, // Set the Hub on Campus Tampa image
    title: 'Hub on Campus Tampa',
    description: 'Luxury student housing with rooftop lounge, fitness center, and study rooms.'
  };
