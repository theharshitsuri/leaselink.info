...
const ListingPageCambridgeWoods = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Bellarmine Hall') // Filter by property name
        );
  ...
  const listing = {
    image: bellarmine, // Set the Cambridge Woods image
    title: 'Bellarmine Hall',
    description: 'Modern student housing options with new appliances and an abundance of fun-filled activities.'
  };
