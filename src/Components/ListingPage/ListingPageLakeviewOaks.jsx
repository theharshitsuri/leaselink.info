...
import lakeview from '../../Images/lakeview.jpg'; // Correct import of Lakeview Oaks image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageLakeviewOaks = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Lakeview Oaks') // Filter by property name
        );
  ...
  const listing = {
    image: lakeview, // Set the Lakeview Oaks image
    title: 'Lakeview Oaks',
    description: 'Scenic student living with serene lake views, modern apartments, resort-style amenities, and close proximity to campus.'
  };
...
export default ListingPageLakeviewOaks;
