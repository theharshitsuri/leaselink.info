...
import cambridgeWoods from '../../Images/cambridge.jpg'; // Correct import of Cambridge Woods image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageCambridgeWoods = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Cambridge Woods') // Filter by property name
        );
  ...
  const listing = {
    image: cambridgeWoods, // Set the Cambridge Woods image
    title: 'Cambridge Woods',
    description: 'Tranquil student living surrounded by lush greenery, featuring spacious apartments, fitness center, and a pool close to campus.'
  };
...
export default ListingPageCambridgeWoods;
