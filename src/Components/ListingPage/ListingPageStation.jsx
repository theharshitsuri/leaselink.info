...
import station from '../../Images/station42.jpg'; // Correct import of the station image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageStation42 = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Station 42') // Filter by property name
        );
  ...
  const listing = {
    image: station, // Set the station42 image
    title: 'Station 42',
    description: 'Student housing with amenities like a pool, gym, and cyber café.',
  };
    ...
    <div>
      ...
      {selectedListing && (
        <Modal
          ...
          className="modal-content w-full lg:w-2/3 max-w-2xl mx-auto p-8 bg-white rounded-lg shadow-lg"
...
export default ListingPageStation42;
