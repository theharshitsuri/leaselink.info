...
const ListingPage42N = () => {
  ...
  const listing = {
    image: N42,
    title: '42N',
    description: 'Student-friendly apartments with pool, hot tub, gym, and study lounge.',
  };
