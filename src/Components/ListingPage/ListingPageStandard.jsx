...
import standard from '../../Images/standard.jpg'; // Correct import of The Standard image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageStandard = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'The Standard') // Filter by property name
        );
  ...
  const listing = {
    image: standard, // Set The Standard image
    title: 'The Standard',
    description: 'Luxury student housing with rooftop pool, fitness center, and study rooms.',
  };
...
export default ListingPageStandard;
