...
import photo from '../../Images/union.jpg'; // Correct import of the union image
...
const ListingPage4050 = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Union on Fletcher') // Filter by property name
        );
  ...
  const listing = {
    image: photo, // Set the union Lofts image
