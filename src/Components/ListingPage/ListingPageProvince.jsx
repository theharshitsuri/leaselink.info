...
import province from '../../Images/province.jpg'; // Correct import of the Province image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageProvince = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'The Province') // Filter by property name
        );
  ...
  const listing = {
    image: province, // Set the Province image
    title: 'Province',
    description: 'Upscale student living with modern amenities like study lounges, fitness center, and swimming pool.'
  };
...
export default ListingPageProvince;
