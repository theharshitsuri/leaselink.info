...
import park from '../../Images/parkplace.jpg'; // Correct import of the Park Place image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageParkPlace = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Park Place') // Filter by property name
        );
  ...
  const listing = {
    image: park, // Set the Park Place image
    title: 'Park Place',
    description: 'Luxury student housing featuring a pool, basketball court, and gym.'
  };
...
export default ListingPageParkPlace;
