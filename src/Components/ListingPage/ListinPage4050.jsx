...
import lofts4050 from '../../Images/4050lofts.jpg'; // Correct import of the lofts image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPage4050 = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', '4050 Lofts') // Filter by property name
        );
  ...
  const listing = {
    image: lofts4050, // Set the 4050 Lofts image
    title: '4050 Lofts',
...
export default ListingPage4050;
