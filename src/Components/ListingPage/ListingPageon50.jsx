...
import on50 from '../../Images/on50.jpg'; // Correct import of the On50 image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageOn50 = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'On50') // Filter by property name
        );
  ...
  const listing = {
    image: on50, // Set the On50 image
    title: 'On50',
    description: 'Affordable student apartments with convenient access to campus, fitness center, and study spaces.'
  };
...
export default ListingPageOn50;
