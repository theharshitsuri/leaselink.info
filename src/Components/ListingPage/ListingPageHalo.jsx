...
import halo from '../../Images/halo.jpg'; // Correct import of the Halo image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageHalo = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Halo 46') // Filter by property name
        );
  ...
  const listing = {
    image: halo, // Set the Halo image
    title: 'Halo 46',
    description: 'Premier student housing with luxury amenities including pools, gaming lounges, and fitness centers.'
  };
...
export default ListingPageHalo;
