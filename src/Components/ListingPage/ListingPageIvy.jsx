...
import ivy from '../../Images/ivy.jpg'; // Correct import of The Ivy image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageTheIvy = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'The Ivy') // Filter by property name
        );
  ...
  const listing = {
    image: ivy, // Set The Ivy image
    title: 'The Ivy',
    description: 'Luxury off-campus housing offering spacious apartments, resort-style pool, fitness center, and study lounges.'
  };
...
export default ListingPageTheIvy;
