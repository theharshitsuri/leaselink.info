...
import retreat from '../../Images/retreat.jpg'; // Correct import of The Retreat image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageTheRetreat = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'The Retreat') // Filter by property name
        );
  ...
  const listing = {
    image: retreat, // Set The Retreat image
    title: 'The Retreat',
    description: 'Upscale student cottages with private bedrooms and premium amenities including resort-style pools, fitness centers, and more.',
  };
...
export default ListingPageTheRetreat;
