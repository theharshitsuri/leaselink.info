...
import lark from '../../Images/Lark.jpg'; // Correct import of the Lark on 42nd image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageLark = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Lark on 42nd') // Filter by property name
        );
  ...
  const listing = {
    image: lark, // Set the Lark on 42nd image
    title: 'Lark on 42nd',
    description: 'Modern student housing with premium amenities like a pool, fitness center, and study rooms.'
  };
...
export default ListingPageLark;
