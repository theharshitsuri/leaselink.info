...
import avalon from '../../Images/avalon.jpg'; // Correct import of the Avalon Heights image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageAvalon = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Avalon Heights') // Filter by property name
        );
  ...
  const listing = {
    image: avalon, // Set the Avalon Heights image
    title: 'Avalon Heights',
    description: 'Upscale living with amenities like a pool, study lounge, and fitness center.'
  };
...
export default ListingPageAvalon;
