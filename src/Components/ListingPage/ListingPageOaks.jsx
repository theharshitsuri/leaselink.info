...
import oaks from '../../Images/oaks.jpg'; // Correct import of the Oaks image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageOaks = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Oaks') // Filter by property name
        );
  ...
  const listing = {
    image: oaks, // Set the Oaks image
    title: 'Oaks',
    description: 'Comfortable off-campus student apartments with modern amenities, close to university, offering convenience and a friendly community.'
  };
...
export default ListingPageOaks;
