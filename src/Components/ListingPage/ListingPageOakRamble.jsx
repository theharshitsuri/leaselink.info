...
import oakRamble from '../../Images/oakramble.jpg'; // Correct import of Oak Ramble image

Modal.setAppElement('#root'); // Accessibility for the modal

const ListingPageOakRamble = () => {
    ...
    const fetchListings = async () => {
      try {
        const q = query(
          ...
          where('propertyName', '==', 'Oak Ramble') // Filter by property name
        );
  ...
  const listing = {
    image: oakRamble, // Set the Oak Ramble image
    title: 'Oak Ramble',
    description: 'Affordable student living with modern amenities including a fitness center, pool, and close proximity to campus.'
  };
...
export default ListingPageOakRamble;
